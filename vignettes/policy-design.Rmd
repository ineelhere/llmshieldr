...
deduplicated before scoring. Synthetic context findings are scored separately
and contribute at most `0.3` per row, so source or anomaly signals cannot by
themselves dominate a report.
