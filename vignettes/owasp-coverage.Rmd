...
at `1.0`. Synthetic context findings are capped at `0.3` per row before being
combined with normal rule findings. Critical findings and explicit block rules
resolve to `block` even when a policy has high thresholds.
