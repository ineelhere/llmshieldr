...
| LLM03:2026 | Excessive agency | `scan_output()` agency phrases, `scan_tool_call()`, guarded `secure_chat()` tool hooks | Lexical pattern, allowlist, and tool argument scans | Output regression and mock hook tests | Lexical patterns miss paraphrases; no user permission, tool schema, or side-effect budget |
