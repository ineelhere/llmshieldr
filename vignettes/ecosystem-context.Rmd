...
| Microsoft Presidio | PII detection and anonymization | Mature recognizers, anonymizers, structured data, extensibility | Optional `presidio_provider()` adapter for stronger PII/PHI workflows |
...
- local Ollama and hosted-provider experiments,
...
- local and hosted-provider examples,
